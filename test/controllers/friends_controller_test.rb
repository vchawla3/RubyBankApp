...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference('Friend.count') do
      post friends_url, params: { friend: { friend1: @friend.friend1, friend2: @friend.friend2 } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { friend1: @friend.friend1, friend2: @friend.friend2 } }
